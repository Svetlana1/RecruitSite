...
import demo.webtasks.services.mocks.WebtasksServiceManager;
...
public abstract class AbstractWebtasksServletHandler extends HttpServlet
	...
	public final void init(ServletConfig config) throws ServletException {
		...
		emailService = WebtasksServiceManager.getInstance(
				config.getServletContext()).getEmailService();
		super.init(config);
	}

	/**
	 * Additional code which does not allow to break a logic of
