-- --------------------------------------------------------
-- Сервер:                       127.0.0.1
-- Версія сервера:               5.5.5-10.0.16-MariaDB - mariadb.org binary distribution
-- ОС сервера:                   Win64
...
CREATE TABLE IF NOT EXISTS `order` (
  ...
  CONSTRAINT `FK_order_client` FOREIGN KEY (`id_client`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
-- Dumping structure for таблиця coffee.user
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `securiteNumber` longtext NOT NULL,
  PRIMARY KEY (`id`),
...
-- Dumping structure for таблиця information_schema.ALL_PLUGINS
...
-- Dumping structure for таблиця information_schema.APPLICABLE_ROLES
...
-- Dumping structure for таблиця information_schema.CHARACTER_SETS
...
-- Dumping structure for таблиця information_schema.CLIENT_STATISTICS
...
-- Dumping structure for таблиця information_schema.COLLATIONS
...
-- Dumping structure for таблиця information_schema.COLLATION_CHARACTER_SET_APPLICABILITY
...
-- Dumping structure for таблиця information_schema.COLUMNS
...
-- Dumping structure for таблиця information_schema.COLUMN_PRIVILEGES
...
-- Dumping structure for таблиця information_schema.ENABLED_ROLES
...
-- Dumping structure for таблиця information_schema.ENGINES
...
-- Dumping structure for таблиця information_schema.EVENTS
...
-- Dumping structure for таблиця information_schema.FILES
...
-- Dumping structure for таблиця information_schema.GLOBAL_STATUS
...
-- Dumping structure for таблиця information_schema.GLOBAL_VARIABLES
...
-- Dumping structure for таблиця information_schema.INDEX_STATISTICS
...
-- Dumping structure for таблиця information_schema.INNODB_BUFFER_PAGE
...
-- Dumping structure for таблиця information_schema.INNODB_BUFFER_PAGE_LRU
...
-- Dumping structure for таблиця information_schema.INNODB_BUFFER_POOL_STATS
...
-- Dumping structure for таблиця information_schema.INNODB_CHANGED_PAGES
...
-- Dumping structure for таблиця information_schema.INNODB_CMP
...
-- Dumping structure for таблиця information_schema.INNODB_CMPMEM
...
-- Dumping structure for таблиця information_schema.INNODB_CMPMEM_RESET
...
-- Dumping structure for таблиця information_schema.INNODB_CMP_PER_INDEX
...
-- Dumping structure for таблиця information_schema.INNODB_CMP_PER_INDEX_RESET
...
-- Dumping structure for таблиця information_schema.INNODB_CMP_RESET
...
-- Dumping structure for таблиця information_schema.INNODB_FT_BEING_DELETED
...
-- Dumping structure for таблиця information_schema.INNODB_FT_CONFIG
...
-- Dumping structure for таблиця information_schema.INNODB_FT_DEFAULT_STOPWORD
...
-- Dumping structure for таблиця information_schema.INNODB_FT_DELETED
...
-- Dumping structure for таблиця information_schema.INNODB_FT_INDEX_CACHE
...
-- Dumping structure for таблиця information_schema.INNODB_FT_INDEX_TABLE
...
-- Dumping structure for таблиця information_schema.INNODB_LOCKS
...
-- Dumping structure for таблиця information_schema.INNODB_LOCK_WAITS
...
-- Dumping structure for таблиця information_schema.INNODB_METRICS
...
-- Dumping structure for таблиця information_schema.INNODB_SYS_COLUMNS
...
-- Dumping structure for таблиця information_schema.INNODB_SYS_DATAFILES
...
-- Dumping structure for таблиця information_schema.INNODB_SYS_FIELDS
...
-- Dumping structure for таблиця information_schema.INNODB_SYS_FOREIGN
...
-- Dumping structure for таблиця information_schema.INNODB_SYS_FOREIGN_COLS
...
-- Dumping structure for таблиця information_schema.INNODB_SYS_INDEXES
...
-- Dumping structure for таблиця information_schema.INNODB_SYS_TABLES
...
-- Dumping structure for таблиця information_schema.INNODB_SYS_TABLESPACES
...
-- Dumping structure for таблиця information_schema.INNODB_SYS_TABLESTATS
...
-- Dumping structure for таблиця information_schema.INNODB_TRX
...
-- Dumping structure for таблиця information_schema.KEY_CACHES
...
-- Dumping structure for таблиця information_schema.KEY_COLUMN_USAGE
...
-- Dumping structure for таблиця information_schema.PARAMETERS
...
-- Dumping structure for таблиця information_schema.PARTITIONS
...
-- Dumping structure for таблиця information_schema.PLUGINS
...
-- Dumping structure for таблиця information_schema.PROCESSLIST
...
-- Dumping structure for таблиця information_schema.PROFILING
...
-- Dumping structure for таблиця information_schema.REFERENTIAL_CONSTRAINTS
...
-- Dumping structure for таблиця information_schema.ROUTINES
...
-- Dumping structure for таблиця information_schema.SCHEMATA
...
-- Dumping structure for таблиця information_schema.SCHEMA_PRIVILEGES
...
-- Dumping structure for таблиця information_schema.SESSION_STATUS
...
-- Dumping structure for таблиця information_schema.SESSION_VARIABLES
...
-- Dumping structure for таблиця information_schema.STATISTICS
...
-- Dumping structure for таблиця information_schema.TABLES
...
-- Dumping structure for таблиця information_schema.TABLESPACES
...
-- Dumping structure for таблиця information_schema.TABLE_CONSTRAINTS
...
-- Dumping structure for таблиця information_schema.TABLE_PRIVILEGES
...
-- Dumping structure for таблиця information_schema.TABLE_STATISTICS
...
-- Dumping structure for таблиця information_schema.TRIGGERS
...
-- Dumping structure for таблиця information_schema.USER_PRIVILEGES
...
-- Dumping structure for таблиця information_schema.USER_STATISTICS
...
-- Dumping structure for таблиця information_schema.VIEWS
...
-- Dumping structure for таблиця information_schema.XTRADB_INTERNAL_HASH_TABLES
...
-- Dumping structure for таблиця information_schema.XTRADB_READ_VIEW
...
-- Dumping structure for таблиця information_schema.XTRADB_RSEG
...
-- Dumping structure for таблиця mysql.columns_priv
...
-- Dumping structure for таблиця mysql.column_stats
...
-- Dumping structure for таблиця mysql.db
...
-- Dumping structure for таблиця mysql.event
...
-- Dumping structure for таблиця mysql.func
...
-- Dumping structure for таблиця mysql.general_log
...
-- Dumping structure for таблиця mysql.gtid_slave_pos
...
-- Dumping structure for таблиця mysql.help_category
...
-- Dumping structure for таблиця mysql.help_keyword
...
-- Dumping structure for таблиця mysql.help_relation
...
-- Dumping structure for таблиця mysql.help_topic
...
-- Dumping structure for таблиця mysql.host
...
-- Dumping structure for таблиця mysql.index_stats
...
-- Dumping structure for таблиця mysql.innodb_index_stats
...
-- Dumping structure for таблиця mysql.innodb_table_stats
...
-- Dumping structure for таблиця mysql.plugin
...
-- Dumping structure for таблиця mysql.proc
...
-- Dumping structure for таблиця mysql.procs_priv
...
-- Dumping structure for таблиця mysql.proxies_priv
...
-- Dumping structure for таблиця mysql.roles_mapping
...
-- Dumping structure for таблиця mysql.servers
...
-- Dumping structure for таблиця mysql.slow_log
...
-- Dumping structure for таблиця mysql.tables_priv
...
-- Dumping structure for таблиця mysql.table_stats
...
-- Dumping structure for таблиця mysql.time_zone
...
-- Dumping structure for таблиця mysql.time_zone_leap_second
...
-- Dumping structure for таблиця mysql.time_zone_name
...
-- Dumping structure for таблиця mysql.time_zone_transition
...
-- Dumping structure for таблиця mysql.time_zone_transition_type
...
-- Dumping structure for таблиця mysql.user
CREATE TABLE IF NOT EXISTS `user` (
  `Host` char(60) COLLATE utf8_bin NOT NULL DEFAULT '',
  `User` char(80) COLLATE utf8_bin NOT NULL DEFAULT '',
...
-- Dumping structure for таблиця performance_schema.accounts
...
-- Dumping structure for таблиця performance_schema.cond_instances
...
-- Dumping structure for таблиця performance_schema.events_stages_current
...
-- Dumping structure for таблиця performance_schema.events_stages_history
...
-- Dumping structure for таблиця performance_schema.events_stages_history_long
...
-- Dumping structure for таблиця performance_schema.events_stages_summary_by_account_by_event_name
...
-- Dumping structure for таблиця performance_schema.events_stages_summary_by_host_by_event_name
...
-- Dumping structure for таблиця performance_schema.events_stages_summary_by_thread_by_event_name
...
-- Dumping structure for таблиця performance_schema.events_stages_summary_by_user_by_event_name
...
-- Dumping structure for таблиця performance_schema.events_stages_summary_global_by_event_name
...
-- Dumping structure for таблиця performance_schema.events_statements_current
...
-- Dumping structure for таблиця performance_schema.events_statements_history
...
-- Dumping structure for таблиця performance_schema.events_statements_history_long
...
-- Dumping structure for таблиця performance_schema.events_statements_summary_by_account_by_event_name
...
-- Dumping structure for таблиця performance_schema.events_statements_summary_by_digest
...
-- Dumping structure for таблиця performance_schema.events_statements_summary_by_host_by_event_name
...
-- Dumping structure for таблиця performance_schema.events_statements_summary_by_thread_by_event_name
...
-- Dumping structure for таблиця performance_schema.events_statements_summary_by_user_by_event_name
...
-- Dumping structure for таблиця performance_schema.events_statements_summary_global_by_event_name
...
-- Dumping structure for таблиця performance_schema.events_waits_current
...
-- Dumping structure for таблиця performance_schema.events_waits_history
...
-- Dumping structure for таблиця performance_schema.events_waits_history_long
...
-- Dumping structure for таблиця performance_schema.events_waits_summary_by_account_by_event_name
...
-- Dumping structure for таблиця performance_schema.events_waits_summary_by_host_by_event_name
...
-- Dumping structure for таблиця performance_schema.events_waits_summary_by_instance
...
-- Dumping structure for таблиця performance_schema.events_waits_summary_by_thread_by_event_name
...
-- Dumping structure for таблиця performance_schema.events_waits_summary_by_user_by_event_name
...
-- Dumping structure for таблиця performance_schema.events_waits_summary_global_by_event_name
...
-- Dumping structure for таблиця performance_schema.file_instances
...
-- Dumping structure for таблиця performance_schema.file_summary_by_event_name
...
-- Dumping structure for таблиця performance_schema.file_summary_by_instance
...
-- Dumping structure for таблиця performance_schema.hosts
...
-- Dumping structure for таблиця performance_schema.host_cache
...
-- Dumping structure for таблиця performance_schema.mutex_instances
...
-- Dumping structure for таблиця performance_schema.objects_summary_global_by_type
...
-- Dumping structure for таблиця performance_schema.performance_timers
...
-- Dumping structure for таблиця performance_schema.rwlock_instances
...
-- Dumping structure for таблиця performance_schema.session_account_connect_attrs
...
-- Dumping structure for таблиця performance_schema.session_connect_attrs
...
-- Dumping structure for таблиця performance_schema.setup_actors
...
-- Dumping structure for таблиця performance_schema.setup_consumers
...
-- Dumping structure for таблиця performance_schema.setup_instruments
...
-- Dumping structure for таблиця performance_schema.setup_objects
...
-- Dumping structure for таблиця performance_schema.setup_timers
...
-- Dumping structure for таблиця performance_schema.socket_instances
...
-- Dumping structure for таблиця performance_schema.socket_summary_by_event_name
...
-- Dumping structure for таблиця performance_schema.socket_summary_by_instance
...
-- Dumping structure for таблиця performance_schema.table_io_waits_summary_by_index_usage
...
-- Dumping structure for таблиця performance_schema.table_io_waits_summary_by_table
...
-- Dumping structure for таблиця performance_schema.table_lock_waits_summary_by_table
...
-- Dumping structure for таблиця performance_schema.threads
...
-- Dumping structure for таблиця performance_schema.users
...
-- Dumping database structure for recruit
CREATE DATABASE IF NOT EXISTS `recruit` /*!40100 DEFAULT CHARACTER SET utf16 */;
USE `recruit`;


-- Dumping structure for таблиця recruit.communication
CREATE TABLE IF NOT EXISTS `communication` (
  `id` int(11) NOT NULL,
  `employerId` int(11) DEFAULT NULL,
  `employeeId` int(11) DEFAULT NULL,
  `date` datetime DEFAULT NULL,
  `marker` bit(1) DEFAULT NULL,
  `sendingEmail` bit(1) DEFAULT NULL,
  `comment` text,
  PRIMARY KEY (`id`),
  KEY `employerId` (`employerId`),
  KEY `employeeId` (`employeeId`),
  CONSTRAINT `FK_communication_user` FOREIGN KEY (`employerId`) REFERENCES `user` (`id`) ON DELETE SET NULL ON UPDATE SET NULL,
  CONSTRAINT `FK_communication_user_2` FOREIGN KEY (`employeeId`) REFERENCES `user` (`id`) ON DELETE SET NULL ON UPDATE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf16;

-- Data exporting was unselected.


-- Dumping structure for таблиця recruit.knowledge
...
-- Dumping structure for таблиця recruit.knowledge_user
CREATE TABLE IF NOT EXISTS `knowledge_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `knowledgeId` int(11) DEFAULT '0',
  `userId` int(11) DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `knowledgeId` (`knowledgeId`),
  KEY `userId` (`userId`),
  CONSTRAINT `FK_knowledge_user_knowledge` FOREIGN KEY (`knowledgeId`) REFERENCES `knowledge` (`id`) ON DELETE SET NULL ON UPDATE SET NULL,
  CONSTRAINT `FK_knowledge_user_user` FOREIGN KEY (`userId`) REFERENCES `user` (`id`) ON DELETE SET NULL ON UPDATE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf16;

-- Data exporting was unselected.


-- Dumping structure for таблиця recruit.resume
CREATE TABLE IF NOT EXISTS `resume` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `experienceAge` int(11) DEFAULT NULL,
  `education` varchar(50) DEFAULT NULL,
  `driveLicense` int(11) DEFAULT NULL,
  `qualifications` text,
  `workExperience` text,
  ...
  CONSTRAINT `FK_resume_vacancy` FOREIGN KEY (`vacancyId`) REFERENCES `vacancy` (`id`) ON DELETE SET NULL ON UPDATE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf16;

-- Data exporting was unselected.


-- Dumping structure for таблиця recruit.role
CREATE TABLE IF NOT EXISTS `role` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Dumping structure for таблиця recruit.user
CREATE TABLE IF NOT EXISTS `user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `securiteNumber` longtext,
  `resumeId` int(11) DEFAULT NULL,
  `telephone` bigint(20) NOT NULL,
  `lastName` varchar(50) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_user_resume` (`resumeId`),
  KEY `roleId` (`roleId`),
  KEY `email` (`email`),
  CONSTRAINT `FK_user_resume` FOREIGN KEY (`resumeId`) REFERENCES `resume` (`id`) ON DELETE SET NULL ON UPDATE SET NULL,
  CONSTRAINT `FK_user_role` FOREIGN KEY (`roleId`) REFERENCES `role` (`id`) ON DELETE SET NULL ON UPDATE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf16;

-- Data exporting was unselected.


-- Dumping structure for таблиця recruit.vacancy
...
-- Dumping database structure for userbd
CREATE DATABASE IF NOT EXISTS `userbd` /*!40100 DEFAULT CHARACTER SET utf16 */;
USE `userbd`;


-- Dumping structure for таблиця userbd.users
CREATE TABLE IF NOT EXISTS `users` (
